...
# Codegen target - run 'cmake --build . --target hexic_hd_codegen'
# Uses the manifest to drive codegen for all modules (entrypoint + DLLs).
add_custom_target(hexic_hd_codegen
    COMMAND $<TARGET_FILE:rex::rexglue> codegen ${CMAKE_CURRENT_SOURCE_DIR}/hexic_hd_manifest.toml
    WORKING_DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR}
    COMMENT "Generating recompiled code for hexic_hd"
    VERBATIM
)
